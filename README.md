# Airbnb Number Checker API — official examples | CheckNumber

This repository documents the CheckNumber Airbnb Number Checker API integration contract using facts from the expansion manifest.

- Product page: https://checknumber.ai/products/airbnb
...
```bash
curl -X POST "https://api.checknumber.ai/v1/tasks" -H "X-API-Key: ${CHECKNUMBER_API_KEY}" -F "file=@examples/numbers.txt" -F "task_type=airbnb"
...
| --- | --- | --- | --- | --- | --- |
| `airbnb` | Number Checker | phone | 1000–100000 rows | `number, activated` | [docs](https://docs.checknumber.ai/airbnb-checker) |
...
- `airbnb`: https://docs.checknumber.ai/airbnb-checker
